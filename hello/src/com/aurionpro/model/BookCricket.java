...
public class BookCricket {
	...
	public static void main(String[] args) {
		...
		if (num == 1) {
			...
			System.out.println(player2 + " NEEDS " + (++score1) + " SCORE TO WIN MATCH");
			System.out.println();
			...
			while (point != 0 && score1 > score2 && round2 < 12) {
				System.out.print("Enter 1 to open Book :");
				int key = sc.nextInt();
				if (key == 1) {
					int pageNumber = (int) Math.floor(Math.random() * (max - min + 1) + min);
					...
					//System.out.println("Page Number " + pageNumber + "\t\t Point : " + point + "\t\t Score : " + score2+ "\t\t Round Left : " + --temp);
					System.out.println("Page Number " + pageNumber + "\t\t Point : " + point + "\t\t Score : " + score2);
					System.out.println(player2 + " Total Score : " + score2);
					System.out.println(player2 + " Takes " + round2 + " Rounds");
				}
			}
