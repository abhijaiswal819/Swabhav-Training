...
public class SecurityConstants {
    ...
    public static final String REGISTER_USER_PATH = "/user/register"; // Public path that clients can use to register.
    public static final String REGISTER_ROLE_PATH = "/roles/addRole";
}
